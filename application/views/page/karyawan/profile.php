...
<body>
    ...
    <!-- script untuk hide dan show detail profile, edit profile dan edit pass -->
    <script>
    ...
    <!-- script show dan hide passwordF -->
    <script>
    ...
    <!-- sweet alert jika berhasil edit profile -->
    ...
    <!-- sweet alert konfirmasi pass tidak sama denagn pass baru -->
    ...
    <!-- sweet elrt jika berhasil edit password -->
    ...
    <!-- sweet valert jika tidak sama  menginputkan password lama  -->
    ...
    <!-- sweet elrt jika berhasil mengganti Foto -->
